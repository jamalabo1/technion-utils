...
## For case tests & valgrind tests:

For case tests and valgrind tests you can use github actions as runner, take a look at stage.yml at `.github/workflow/stage.yml` file in the repo.

**you must have an executable target named `techsystem26a1`**, if you do, then just copy the actions file and run it manually in the `actions` tab.

---

## Step 0: Correct Project Structure (Library + Executable)

### There is an example file at CMakeLists.txt
